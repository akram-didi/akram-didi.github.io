...
<div class="modal fade" id="delete_<?php echo $unlieu['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
            	<p class="text-center">Etes-vous sure de vouloir supprimer le lieu <?php echo $unlieu['nom']; ?></p>
			</div>
            <div class="modal-footer">
				<form method="POST" action="?action=lieuTraitement">
					<input type="hidden" class="form-control" name="id" value="<?php echo $lieu['id']; ?>">
					<button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Annuler</button>
